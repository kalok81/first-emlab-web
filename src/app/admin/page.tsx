        ...
        <div className="max-w-7xl mx-auto px-4 h-16 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <nav className="hidden md:flex items-center gap-1 bg-slate-100 p-1 rounded-xl">
              ...
              >
                <BookOpen className="w-4 h-4" /> Manage Workshops
              </button>
              <button 
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {activeTab === 'workshops' && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl font-bold text-slate-800">Manage Workshops</h2>
              <button 
        ...
        {activeTab === 'content' && (
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-slate-800 mb-8">Edit Site Content</h2>
            <form onSubmit={handleContentSubmit} className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-8">
              ...
              >
                {isSavingContent ? <Loader2 className="w-5 h-5 animate-spin" /> : 'Save Changes'}
              </button>
            </form>
          </div>
        )}
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl border border-slate-100 overflow-hidden animate-in fade-in zoom-in duration-200">
            <div className="p-6 border-b border-slate-100 flex justify-between items-center">
              <h3 className="font-bold text-lg">{workshopModal.mode === 'add' ? 'Add Workshop' : 'Edit Workshop'}</h3>
            ...
            <form onSubmit={handleWorkshopSubmit} className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-500">Price (e.g. $500)</label>
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-500">Duration (e.g. 2 Hours)</label>
                ...
                <div className="col-span-2 space-y-1">
                  <label className="text-xs font-bold text-slate-500">Google Form URL</label>
              ...
              <div className="flex gap-3 pt-4">
                <button type="button" onClick={() => setWorkshopModal({ ...workshopModal, show: false })} className="flex-1 px-6 py-3 bg-slate-100 rounded-xl font-bold text-slate-600 hover:bg-slate-200 transition-all">Cancel</button>
                <button type="submit" className="flex-[2] px-6 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-100">Save Workshop</button>
              </div>
            </form>
          </div>
        </div>
